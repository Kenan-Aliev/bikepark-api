module.exports = {
  ...
  auth: {
    registration: {
      ...
      sendMailSuccess:
        "Проверьте ваш почтовый ящик, чтобы подтвердить регистрацию",
      validation: {
    ...
    activation: {
      tokenExpired:
        "Срок действия токена истек.Попробуйте заново заполнить форму регистрации",
      hashError: "Ошибка кодировки пароля",
      RegistrationSuccess:
        "Поздравляем! Вы успешно зарегистрировались на нашем сайте",
      RegistrationFailed:
        "Ошибка сохранения пользователя в базе данных.Возможно вы уже зарегистрированы на нашем сайте",
    },
    login: {
